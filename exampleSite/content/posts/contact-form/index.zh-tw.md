...
我們可以將郵寄地址放在 [社交連結]({{< ref "/posts/social-links" >}})上，以便讀者聯繫我們。 但不幸的是，郵件或多或少會被當成垃圾郵件，甚至被過濾。 囙此我們帶來了一個聯系表單的功能。
...
其被設計成可以相容大部分後端。 現時，[Netlify form](https://docs.netlify.com/forms/setup) 和 [Getform](https://getform.io/) 已驗證可用。
